...
const App: FC = () => {
  ...
  return (
    <>
      <button className={classes.btn} type="button" value="list" onClick={() => setView('list')}>Список</button>
      <button className={classes.btn} type="button" value="table" onClick={() => setView('table')}>Таблица</button>
      {isView === 'list' && (
        <div>
